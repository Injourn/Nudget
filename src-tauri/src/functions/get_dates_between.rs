...
pub(crate) fn get_dates_between(
...
pub fn get_dates_between_monthly(
    start_date: &NaiveDate,
    end_date: &NaiveDate,
    value: u32,
) -> Vec<NaiveDate> {
...
pub fn get_dates_between_weekly(
    start_date: &NaiveDate,
    end_date: &NaiveDate,
    value: u32,
) -> Vec<NaiveDate> {
...
pub fn get_succeeding_day_of_month(start_date: &NaiveDate, value: u32) -> NaiveDate {
    ...
    if day_of_month > value {
        return_date = start_date
            ...
            .expect("failed to retrieve date")
            .with_day(value)
            .unwrap();
    } else {
...
pub fn get_succeeding_day_of_week(start_date: &NaiveDate, value: u32) -> NaiveDate {
    ...
    dt.checked_add_days(Days::new(day_difference as u64))
        .unwrap()
        .into()
}
